...
public class ColorSpectrumTables {
	private static WhitePoint WHITEPOINT_ILLUMINANT_A;
	private static WhitePoint WHITEPOINT_ILLUMINANT_B;
	private static WhitePoint WHITEPOINT_ILLUMINANT_C;
	private static WhitePoint WHITEPOINT_D50;
	private static WhitePoint WHITEPOINT_D55;
	private static WhitePoint WHITEPOINT_D65;
	private static WhitePoint WHITEPOINT_D75;
	private static WhitePoint WHITEPOINT_D93;
	private static WhitePoint WHITEPOINT_ILLUMINANT_E;
	private static WhitePoint WHITEPOINT_LCD;
	private static Primaries PRIMARIES_SMPTE_HD; // same as PRIMARIES_REC709
	private static Primaries PRIMARIES_EBU; // 1969
	private static Primaries PRIMARIES_SMPTE_C; // NTSC 1979
	private static Primaries PRIMARIES_SMPTE_240M; // old analog HD 1125/1250
	private static Primaries PRIMARIES_ORIGINAL_NTSC; // old NTSC
	private static Primaries PRIMARIES_YIQ; // old NTSC same as
											// PRIMARIES_ORIGINAL_NTSC 1953
	private static Primaries PRIMARIES_COMMON_COMPUTER;
	private static Primaries PRIMARIES_REC709;
	private static Primaries PRIMARIES_TRINITRON;
	private static Primaries PRIMARIES_APPLE_RGB; // expecting gamma of 1.8
	private static Primaries PRIMARIES_sRGB; // same as PRIMARIES_REC709
	private static Primaries PRIMARIES_ADOBE_RGB; // 1998
	private static Primaries PRIMARIES_WIDE_GAMMUT_RGB;
	private static Primaries PRIMARIES_LCD;
	private static float colorTemp_K[] = new float[54];
	private static float colorTemp_x[] = new float[54];
	private static float colorTemp_y[] = new float[54];
	public static float spectrum_x[] = new float[81];
	public static float spectrum_y[] = new float[81];
	private static Vector<WhitePoint> listWhitePoints;
	private static Vector<Primaries> listPrimaries;
	private static String prefsLocation = System.getProperty("java.home")
			+ System.getProperty("file.separator")
			+ "ColourMath.formulas.config";
	// private static Vector listComboBoxes;
	static {
		WHITEPOINT_ILLUMINANT_A = new WhitePoint("ILLUMINANT_A", 0.4476f,
				0.4074f);
		WHITEPOINT_ILLUMINANT_B = new WhitePoint("ILLUMINANT_B", 0.3484f,
				0.3516f);
		WHITEPOINT_ILLUMINANT_C = new WhitePoint("ILLUMINANT_C", 0.3101f,
				0.3162f);
		...
		WHITEPOINT_ILLUMINANT_E = new WhitePoint("ILLUMINANT_E", 0.3333f,
				0.33333f);
		WHITEPOINT_LCD = new WhitePoint("LCD", 0.327f, 0.354f);
		PRIMARIES_REC709 = new Primaries("REC709", new Point2f(0.640f, 0.330f),
				new Point2f(0.300f, 0.600f), new Point2f(0.150f, 0.060f));
		PRIMARIES_SMPTE_HD = new Primaries("SMPTE_HD", PRIMARIES_REC709);
		PRIMARIES_EBU = new Primaries("EBU", new Point2f(0.640f, 0.330f),
				new Point2f(0.290f, 0.600f), new Point2f(0.150f, 0.060f));
		PRIMARIES_SMPTE_C = new Primaries("SMPTE_C",
				new Point2f(0.635f, 0.340f), new Point2f(0.305f, 0.595f),
				new Point2f(0.155f, 0.070f));
		PRIMARIES_SMPTE_240M = /**/new Primaries("SMPTE_240M", new Point2f(
				0.630f, 0.340f), new Point2f(0.310f, 0.595f), new Point2f(
				0.155f, 0.070f));
		PRIMARIES_ORIGINAL_NTSC = new Primaries("ORIGINAL_NTSC", new Point2f(
				0.670f, 0.330f), new Point2f(0.210f, 0.710f), new Point2f(
				0.140f, 0.080f));
		PRIMARIES_COMMON_COMPUTER = new Primaries("COMMON_COMPUTER",
				new Point2f(0.628f, 0.346f), new Point2f(0.268f, 0.588f),
				new Point2f(0.150f, 0.070f));
		PRIMARIES_YIQ = new Primaries("YIQ", PRIMARIES_ORIGINAL_NTSC);
		PRIMARIES_TRINITRON = new Primaries("TRINITRON", new Point2f(0.625f,
				0.340f), new Point2f(0.280f, 0.595f), new Point2f(0.155f,
				0.070f));
		PRIMARIES_APPLE_RGB = new Primaries("APPLE_RGB", PRIMARIES_TRINITRON);
		PRIMARIES_sRGB = new Primaries("sRGB", PRIMARIES_REC709);
		PRIMARIES_ADOBE_RGB = new Primaries("ADOBE_RGB", new Point2f(0.640f,
				0.330f), new Point2f(0.210f, 0.710f), new Point2f(0.150f,
				0.060f));
		PRIMARIES_WIDE_GAMMUT_RGB = new Primaries("WIDE_GAMMUT_RGB",
				new Point2f(0.735f, 0.265f), new Point2f(0.115f, 0.826f),
				new Point2f(0.157f, 0.018f));
		PRIMARIES_LCD = new Primaries("LCD", new Point2f(0.516f, 0.332f),
				new Point2f(0.315f, 0.506f), new Point2f(0.184f, 0.182f));
	...
	private static void addWhitePoint(WhitePoint wp) {
		...
		while (i < listWhitePoints.size()) {
			if (wp.name
					...
					.toUpperCase()
					.compareTo(
							((WhitePoint) listWhitePoints.elementAt(i)).name
									.trim().toUpperCase()) == 0) {
				doesntexists = false;
	...
	private static void addPrimaries(Primaries pf) {
		boolean doesntexists = true;
		int i = 0;
		while (i < listPrimaries.size()) {
			if (pf.name
					...
					.toUpperCase()
					.compareTo(
							((Primaries) listPrimaries.elementAt(i)).name
									.trim().toUpperCase()) == 0) {
				doesntexists = false;
	...
	private static void initWhitePoints() {
	...
	private static void initPrimaries() {
