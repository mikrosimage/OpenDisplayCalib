...
public class WhiteStep extends Step
{
    ...
    public void buildUI()
    {
        ...
        _whiteStartBut.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e)
            {
                ...
                if (!_isMeasuring)
                {
                    ...
                    {
                        ColorHealerModel._instance.getCurrentMeasuresSet().mesureThisColor(
                                model.getCurrentMeasuresSet(), Color.red, "primary measure");
                        _white31Canvas.repaint();
                        _magnifiedCanvas.repaint();
                        _white76Canvas.repaint();
                        ColorHealerModel._instance.getCurrentMeasuresSet().mesureThisColor(
                                model.getCurrentMeasuresSet(), Color.green, "primary measure");
                        _white31Canvas.repaint();
                        _magnifiedCanvas.repaint();
                        _white76Canvas.repaint();
                        ColorHealerModel._instance.getCurrentMeasuresSet().mesureThisColor(
                                model.getCurrentMeasuresSet(), Color.blue, "primary measure");
                        _white31Canvas.repaint();
                        _magnifiedCanvas.repaint();
                        _white76Canvas.repaint();
                    }
        ...
        TitledBorder softCorrBorder = BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black),
            ...
            public void mousePressed(MouseEvent e)
            {
                ...
                if (!useSoftCorr.isSelected())
                {
                    WhiteSoftwareCorrection corr = new WhiteSoftwareCorrection(
                            Integer.parseInt(rTxt.getText()) * 65535 / 4095,
                            Integer.parseInt(gTxt.getText()) * 65535 / 4095,
                            Integer.parseInt(bTxt.getText()) * 65535 / 4095);
                    ...
                    public void run()
                    {
                        ...
                        try
                        {
                            ColorHealerModel._instance.getSocketServer().sendMessage(
                                    "SHOULD_DISPLAY " + screenIndex + " " + true + "\n");
                            oneWhite();
                            ColorHealerModel._instance.getSocketServer().sendMessage(
        ...
        final JPanel grayCanvasPan = new JPanel(new FlowLayout(FlowLayout.CENTER));
        ...
        TitledBorder measureBorder2 = BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black),
                "Measures");
        ...
        TitledBorder displayBorder2 = BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black),
                "Display");
        ...
        primariesCombo2.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent arg0)
            {
                _gray31Canvas.setPrimariesToDisplay((IRgbPrimary) primariesCombo2.getSelectedItem());
                _gray31Canvas.repaint();
                _gray76Canvas.setPrimariesToDisplay((IRgbPrimary) primariesCombo2.getSelectedItem());
    ...
    public void oneWhite()
    {
        ...
        boolean res = measures.mesureThisColor(model.getCurrentMeasuresSet(), Color.white, "white measure");
        ...
        if (measures.getMeasure(Color.white) != null)
        {
            ...
            if ((dx > colorDelta) || (dy > colorDelta) || (dY > lumDelta) || (miredDelta > target.getTCDelta()))
            {
    ...
    public void white()
    {
        ...
        Runnable runnable = new Runnable() {
...

            {
                ...
                if ((white != null) && (red != null) && (green != null) && (blue != null))
                {
                    WhiteSoftwareCorrection tmpSoftCorrection = new WhiteSoftwareCorrection(white.getValue(), red
                            .getValue(), green.getValue(), blue.getValue());
                    rTxt.setText("" + tmpSoftCorrection.getRedMaxValue() * 4095 / 65535);
                    gTxt.setText("" + tmpSoftCorrection.getGreenMaxValue() * 4095 / 65535);
                    bTxt.setText("" + tmpSoftCorrection.getBlueMaxValue() * 4095 / 65535);
                    checkSoftCorrButt.setEnabled(true);
    ...
    public void gray()
    {
        ...
        Runnable runnable = new Runnable() {
            public void run()
            {
                ...
                do
                {
                    boolean res = measures.mesureThisColor(model.getCurrentMeasuresSet(), ITarget.GAMMA_GRAY,
                            "bias measure");
                    ...
                    {
                        Point3f measuredPoint = measures.getMeasure(ITarget.GAMMA_GRAY).getValue();
                        _magnifiedCanvas2.setMeasuredPoint(measuredPoint._a, measuredPoint._b);
                        ...
                        if (dY2 < lumDelta)
                            ...
                            _dYLab2.setForeground(Color.red);
                        _xLab2.setText(String.valueOf(((int) (measuredPoint._a * 1000) / 1000f)));
                        _yLab2.setText(String.valueOf(((int) (measuredPoint._b * 1000) / 1000f)));
                        _YLab2.setText(String.valueOf(((int) (measuredPoint._c * 1000) / 1000f)));
                        ...
                        _dcolorTemp2.setText("" + (approxColorTemp - targetTemp));

                        if ((dx2 > colorDelta) || (dy2 > colorDelta) || (dY2 > lumDelta))
                        {
    ...
    public void valid()
    {
        ...
        int approxColorTemp = (int) EStandardIlluminants.getApproximateColorTemperature(new Point2f(measuredPoint._a,
                measuredPoint._b));
        int targetTemp = target.getColorTemp().getValue();
        int miredDelta = 1000000 / approxColorTemp - 1000000 / targetTemp;
        miredDelta = Math.abs(miredDelta);
