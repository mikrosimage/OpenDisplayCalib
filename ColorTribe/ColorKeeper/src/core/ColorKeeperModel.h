...
class ColorKeeperModel : public QObject {
  ...
  public:
    enum PrinterLights { RED, GREEN, BLUE };
    ...
    void getOut();
    const ILocalHost &getDeviceInfo() const { return *(_deviceInfo); }
    ...
    std::string
    getScreenProfilNamePath(const unsigned int &osScreenIndex) const;
    ...
    const QStringList &getCustomLuts() { return _customLuts; }
    const QStringList &getCustomPatterns() { return _customPatterns; }
    ...
    unsigned int getXScreensNumber() const {
    ...
    float getCalibWindowsZoom() { return _calibWindowsZoom; }
    void setCalibWindowsZoom(float zoom);

    int getCalibWindowsTranslateX() { return _calibWindowsTranslateX; }
    int getCalibWindowsTranslateY() { return _calibWindowsTranslateY; }
...
signals:
    ...
    void plChanged(unsigned int, float,
